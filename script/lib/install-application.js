...
module.exports = function(packagedAppPath, installDir) {
  ...
  if (process.platform === 'darwin') {
    ...
    const atomExecutableName =
      CONFIG.channel === 'stable' ? 'pros-editor' : 'pros-editor-' + CONFIG.channel;
    const apmExecutableName =
      CONFIG.channel === 'stable' ? 'pros-editor-apm' : 'pros-editor-apm-' + CONFIG.channel;
    const appName =
      CONFIG.channel === 'stable'
        ? 'PROS Editor'
        : startCase('PROS Editor ' + CONFIG.channel);
