...
const { previousModuleCompile } = require('../../src/native-compile-cache');
...
>>>>>>> 4a9d56f52cab00a22744858d4077600d5365197a
...
<<<<<<< HEAD
    const appName = CONFIG.channel !== 'stable' ? `pros-editor-${CONFIG.channel}` : 'pros-editor'
    let architecture
